...
const Play = () => {
  ...
  const handleBtn1 = () => {
    locations[locationInfo]["button functions"][0](setLocationInfo);
  };
  const handleBtn2 = () => {
    locations[locationInfo]["button functions"][1](setLocationInfo);
  };
  const handleBtn3 = () => {
    locations[locationInfo]["button functions"][2](setLocationInfo);
  };
  const handleBtn4 = () => {
    locations[locationInfo]["button functions"][3](setLocationInfo);
  };
  return (
      ...
      <div id="game">
        ...
        {locationInfo !== null ? (
          <>
            ...
            <div id="text">{locations[locationInfo].text}</div>
          </>
        ) : (
          <>
            <div id="controls">
              <button
                id="button1"
                onClick={() => {
                  locations[0]["button functions"][0](setLocationInfo);
                }}
              >
                Shop
              </button>
              <button
                id="button2"
                onClick={() => {
                  locations[0]["button functions"][1](setLocationInfo);
                }}
              >
                Walk through town
              </button>
              <button
                id="button3"
                onClick={() => {
                  locations[0]["button functions"][2](setLocationInfo);
                }}
              >
